...
<div class="space-y-6">
    ...
    <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
                ...
                <thead class="bg-gray-100 border-b">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left">
                            <a href="<?php echo e(sortUrl('supplier_code')); ?>"
                               class="inline-flex items-center gap-1 hover:text-blue-600">
                                Code <span class="text-xs"><?php echo e(sortIcon('supplier_code')); ?></span>
                            </a>
                        </th>

                        <th class="px-6 py-4 text-left">
                            <a href="<?php echo e(sortUrl('supplier_name')); ?>"
                               class="inline-flex items-center gap-1 hover:text-blue-600">
                                Supplier Name <span class="text-xs"><?php echo e(sortIcon('supplier_name')); ?></span>
                            </a>
                        </th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3 text-center">
                                <?php echo e($suppliers->firstItem() + $loop->index); ?>
                            ...
                            <td class="px-4 py-3 text-gray-600">
                                <?php echo e($supplier->contact_phone); ?>

                            </td>

                            <td class="px-4 py-3 text-gray-600">
                                <?php echo e($supplier->contact_email); ?>
                            ...
                            <td class="px-4 py-3 text-center">
                                <span class="px-2 py-1 rounded text-xs font-semibold
                                    <?php echo e($supplier->status === 'active'
                            ...
                            <td class="px-4 py-3 text-center">
                                <div class="flex justify-center gap-2">
                                    <a href="<?php echo e(route('admin.suppliers.edit', $supplier->id)); ?>" class="p-1 text-blue-600 hover:text-blue-800" title="Edit">
                                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                                        </svg>
                                    </a>

                                    <form action="<?php echo e(route('admin.suppliers.destroy', $supplier->id)); ?>" method="POST" onsubmit="return confirm('Delete this supplier?')" style="display:inline">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="px-6 py-4 border-t bg-gray-50 flex flex-col sm:flex-row sm:justify-between gap-4">
            ...
            <?php echo e($suppliers->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mardiana Syafitry\projInOutBarang\resources\views/admin/suppliers/index.blade.php ENDPATH**/ ?>