    ...
    <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
                ...
                <thead class="bg-gray-100 border-b">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left">
                            <a href="<?php echo e(sortUrl('category_code')); ?>"
                               class="inline-flex items-center gap-1 hover:text-blue-600">
                                Code <span class="text-xs"><?php echo e(sortIcon('category_code')); ?></span>
                            </a>
                        </th>
                        ...
                        <th class="px-6 py-4 text-left">
                            <a href="<?php echo e(sortUrl('category_name')); ?>"
                               class="inline-flex items-center gap-1 hover:text-blue-600">
                                Name <span class="text-xs"><?php echo e(sortIcon('category_name')); ?></span>
                            </a>
                        </th>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 font-mono text-blue-600 font-semibold">
                            <?php echo e($category->category_code); ?>
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex justify-center gap-2">
                                <a href="<?php echo e(route('admin.categories.edit', $category->id)); ?>" class="p-1 text-blue-600 hover:text-blue-800" title="Edit">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"/>
                                    </svg>
                                </a>

                                <form method="POST" action="<?php echo e(route('admin.categories.destroy', $category->id)); ?>" onsubmit="return confirm('Delete this category?')" style="display:inline">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="px-6 py-4 border-t bg-gray-50 flex flex-col sm:flex-row sm:justify-between gap-4">
            <p class="text-sm text-gray-600">
                Showing
                <strong><?php echo e($categories->firstItem() ?? 0); ?></strong>
                to
                <strong><?php echo e($categories->lastItem() ?? 0); ?></strong>
                of
                <strong><?php echo e($categories->total()); ?></strong>
                items
            </p>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mardiana Syafitry\projInOutBarang\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>