        ...
        <div>
            ...
            <textarea name="category_description"
                      ...
                      class="w-full mt-1 rounded-lg border border-gray-300
                             text-gray-900
                             focus:ring-emerald-500 focus:border-emerald-500"
                      placeholder="Optional"><?php echo e(old('category_description', $category->category_description)); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mardiana Syafitry\projInOutBarang\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>