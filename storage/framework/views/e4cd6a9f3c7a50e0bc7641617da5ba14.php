...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
            ...
            <p class="text-3xl font-bold text-green-600 mt-2"><?php echo e($totalStock); ?></p>
        </div>
        <div class="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
        ...
        <div class="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
            ...
            <p class="text-3xl font-bold text-red-600 mt-2"><?php echo e($outOfStockCount); ?></p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <form method="GET" id="filterForm" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="report_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                        <option value="all" <?php echo e(request('report_type', 'all') == 'all' ? 'selected' : ''); ?>>All Items</option>
                        <option value="low" <?php echo e(request('report_type') == 'low' ? 'selected' : ''); ?>>Low Stock</option>
                        <option value="out_of_stock" <?php echo e(request('report_type') == 'out_of_stock' ? 'selected' : ''); ?>>Out of Stock</option>
                    </select>
                </div>
            ...
            <div class="flex flex-wrap gap-2 pt-4">
                ...
                <a href="<?php echo e(route('admin.reports.stock')); ?>" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium">
                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <table class="w-full min-w-[800px] text-sm">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center font-semibold text-gray-900">Unit</th>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 text-gray-900 font-medium">
                                <?php echo e(($items->currentPage() - 1) * $items->perPage() + $loop->index + 1); ?>

                            </td>
                            <td class="px-6 py-4">
                                <span class="font-mono text-blue-600 font-semibold"><?php echo e($item->item_code); ?></span>
                            </td>
                            <td class="px-6 py-4 text-gray-900 font-medium">
                            ...
                            <td class="px-6 py-4 text-center">
                                <span class="px-2 py-1 rounded text-xs font-medium <?php echo e($item->condition == 'good' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'); ?>">
                            ...
                            <td class="px-6 py-4 text-center font-bold <?php echo e($item->stock == 0 ? 'text-red-600' : ($item->stock < $item->min_stock ? 'text-yellow-600' : 'text-green-600')); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mardiana Syafitry\projInOutBarang\resources\views/admin/reports/stock.blade.php ENDPATH**/ ?>