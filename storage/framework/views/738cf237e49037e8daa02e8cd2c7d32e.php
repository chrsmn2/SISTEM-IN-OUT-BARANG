...
<?php $__env->startSection('title', 'Transaction Report'); ?>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <form method="GET" id="filterForm" class="space-y-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="type" onchange="document.getElementById('filterForm').submit();" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                        <option value="incoming" <?php echo e(request('type', 'incoming') == 'incoming' ? 'selected' : ''); ?>>Incoming Items</option>
                        <option value="outgoing" <?php echo e(request('type') == 'outgoing' ? 'selected' : ''); ?>>Outgoing Items</option>
                    </select>
                </div>
                    ...
                    <select name="month" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                        <?php for($i = 1; $i <= 12; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e(request('month', now()->month) == $i ? 'selected' : ''); ?>>
                                <?php echo e(now()->createFromFormat('m', $i)->format('F')); ?>
                ...
                <div>
                    ...
                    <select name="year" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                        <?php for($i = now()->year; $i >= now()->year - 5; $i--): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e(request('year', now()->year) == $i ? 'selected' : ''); ?>>
                                <?php echo e($i); ?>
                ...
                <?php if(request('type', 'incoming') == 'incoming'): ?>
                <div>
                    ...
                    <select name="supplier" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                        ...
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($sup->id); ?>" <?php echo e(request('supplier') == $sup->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <select name="per_page" onchange="document.getElementById('filterForm').submit();"
                        ...
                        <?php $__currentLoopData = [5,10,15,25]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($size); ?>" <?php echo e($perPage == $size ? 'selected' : ''); ?>>
                                <?php echo e($size); ?> items
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            ...
            <div class="flex flex-wrap gap-2 pt-4">
                ...
                <a href="<?php echo e(route('admin.reports.movement')); ?>" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-medium">
                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div>
                            ...
                            <p class="text-sm font-bold text-blue-600 mt-1"><?php echo e($movement->code ?? '-'); ?></p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-600 font-medium uppercase">Date</p>
                            <p class="text-sm font-medium text-gray-900 mt-1">
                                <?php if(request('type', 'incoming') == 'incoming'): ?>
                                    <?php echo e(\Carbon\Carbon::parse($movement->incoming_date)->format('d-m-Y')); ?>

                                <?php else: ?>
                                    <?php echo e(\Carbon\Carbon::parse($movement->outgoing_date)->format('d-m-Y')); ?>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 mt-1"><?php echo e($movement->admin?->name ?? '-'); ?></p>
                        </div>
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900 mt-1">
                                <?php if(request('type', 'incoming') == 'incoming'): ?>
                                    <?php echo e($movement->supplier?->supplier_name ?? '-'); ?>

                                <?php else: ?>
                                    <?php echo e($movement->departement?->departement_name ?? $movement->destination ?? '-'); ?>
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <?php if(request('type', 'incoming') == 'incoming' && $movement->details?->first()?->notes): ?>
                                    <th class="px-6 py-3 text-left font-semibold text-gray-900">Notes</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200">
                            <?php $__empty_2 = true; $__currentLoopData = $movement->details ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-3">
                                        <span class="font-mono text-blue-600 font-semibold"><?php echo e($detail->item?->item_code ?? '-'); ?></span>
                                    </td>
                                    <td class="px-6 py-3 text-gray-900 font-medium">
                                        <?php echo e($detail->item?->item_name ?? '-'); ?>
                                    ...
                                    <td class="px-6 py-3 text-gray-700">
                                        <?php echo e($detail->unit?->unit_name ?? '-'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mardiana Syafitry\projInOutBarang\resources\views/admin/reports/movement.blade.php ENDPATH**/ ?>