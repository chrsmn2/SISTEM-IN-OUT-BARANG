...
<div class="max-w-xl mx-auto bg-white rounded-xl shadow-xl border">
    ...
    <!-- Form -->
    <form action="<?php echo e(route('admin.units.update', $unit->id)); ?>"
          method="POST"
          class="p-6 space-y-3">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <textarea name="unit_description"
                      ...
                      class="w-full mt-1 rounded-lg border border-gray-300
                             text-gray-900
                             focus:ring-emerald-500 focus:border-emerald-500"
                      placeholder="Optional"><?php echo e(old('unit_description', $unit->unit_description)); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bismillah\SISTEM-IN-OUT-BARANG\resources\views/admin/units/edit.blade.php ENDPATH**/ ?>